...
const DriverCard: React.FC<Props> = ({ driver }) => {
  ...
  const auraColor = isImplemented ? 'rgba(16, 185, 129, 0.26)' : 'rgba(34, 211, 238, 0.22)';
  ...
  return (
    <div
      className={`
        relative w-[95vw] lg:w-[1320px] xl:w-[1440px]
        ${showEvidence ? 'h-[84vh]' : 'h-auto min-h-[680px]'}
        flex items-stretch justify-center
      `}
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -inset-5 z-0 blur-3xl"
        style={{
          background: `radial-gradient(ellipse at center, ${auraColor} 0%, rgba(15, 23, 42, 0) 72%)`,
        }}
      />
      ...
      <div
        ...
        shadow-2xl ${glowColor} shadow-[0_38px_140px_rgba(16,185,129,0.22)]
