         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-8 bg-slate-900/40 border border-slate-800 rounded-none flex flex-col justify-between">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="w-full h-1.5 bg-slate-800 rounded-none">
                            <div className="w-full h-full bg-cyan-500 rounded-none"></div>
                        </div>
                    </div>
            ...
            <div className="p-8 bg-slate-900/40 border border-slate-800 rounded-none">
                ...
                <div className="flex gap-2 justify-center mt-4">
                    {/* DN1: Implementado */}
                    <span className="px-2 py-1 bg-emerald-500/20 text-emerald-400 text-[10px] rounded-none font-mono border border-emerald-500/30" title="Implementado">
                        DN1
                    </span>
                    {/* DN4: POC Realizada (Conforme logs do Locust) */}
                    <span className="px-2 py-1 bg-cyan-500/10 text-cyan-400 text-[10px] rounded-none font-mono border border-cyan-500/20" title="POC Validada">
                        DN4
                    </span>
                </div>
            </div>
