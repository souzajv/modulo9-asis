...
const NextSteps: React.FC<NextStepsProps> = ({ deliverables = NEXT_SPRINT_DELIVERABLES, sprintId = '01' }) => {
  const nextSprintNum = sprintId === '01' ? '02' : sprintId === '02' ? '03' : '04';
  const focusLabel = sprintId === '01'
    ? 'Requisitos Funcionais e Não Funcionais como Código'
    : sprintId === '02'
      ? 'Integração e Observabilidade'
      : 'Dashboard de Qualidade e Governança';
      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="mb-12">
          ...
          <p className="text-xl text-slate-400 font-light max-w-2xl">
            Entrega focada em: <strong className="text-emerald-400">{focusLabel}</strong>.
          </p>
        </div>
